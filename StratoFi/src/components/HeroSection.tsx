        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="flex flex-col items-center text-center lg:items-start lg:text-left space-y-6 md:space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 w-full max-w-md animate-fade-in">
              <Button className="btn-gradient text-white h-12 px-8 rounded-lg text-lg" onClick={() => navigate("/dashboard")}>
                Try Free Demo
                <ChevronRight className="ml-2 h-4 w-4" />
              </Button>
              <Button variant="outline" className="h-12 px-8 rounded-lg text-lg glass-input">
          ...
          <div className="relative lg:h-[500px] animate-fade-in">
            ...
            <div className="relative h-full rounded-2xl overflow-hidden glass-card border border-white/20 shadow-xl">
              {theme === "dark" ? (
                <img 
                  src="/lovable-uploads/04390c18-6732-4d59-ab44-d41e0f3569dc.png" 
                  alt="Financial data visualization - dark mode" 
                  className="w-full h-full object-cover opacity-90"
                />
              ) : (
                <img 
                  src="/chart-light.png" 
                  alt="Financial data visualization - light mode" 
                  className="w-full h-full object-cover opacity-90"
                />
              )}
